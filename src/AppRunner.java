...
public class AppRunner {
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            ...
            //long range 15 to 60
            //short range 5 to 35
            Sensor sensor1 = new Sensor(3, 2, 0, MIDDLE, 3);
            Sensor sensor2 = new Sensor(3, 1, 0, MIDDLE, 3);
            Sensor sensor3 = new Sensor(3, 0, 0, MIDDLE, 3); 
            Sensor sensor4 = new Sensor(3,  0, 0, LEFT, 3);
            Sensor sensor5 = new Sensor(3, 0, 2, LEFT, 3);
